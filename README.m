%% This set of files contains the Matlab code for the superpixel based
%% semisupervised active learning (SSAL) with the density peak (DP) 
%% augmentation proposed in the following paper:
%
%  [1] C. Liu, J. Li and L. He, Superpixel-Based Semisupervised Active 
%  Learning for Hyperspectral Image Classification. IEEE Journal of 
%  Selected Topics in Applied Earth Observations and Remote Sensing, 
%  vol.12, no.1, pp. 357-370, Jan. 2019.
%
%% The SLIC superpixel segmentation for hyperspectral images is implemented according to:
%
%  [2] Xiang Xu, Jun Li, Changshan Wu, Antonio Plaza,
...
%
%  [3] I. D¨®pido, J. Li, P. R. Marpu, A. Plaza, J. M. Bioucas Dias and 
...
%
%  [5] J. Li, J. M. Bioucas-Dias and A. Plaza, 
