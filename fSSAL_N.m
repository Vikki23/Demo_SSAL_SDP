function [varargout] = fSSAL_N(varargin)
%
% Semi-Supervised Learing (SSL): self-learning
% Active Learning (AL): BT - sort the BT values in ascending order 
% Spatial Constraint: 4-connected neighbor
%
% [mlr_results,mpm_results,train] = fSSAL_N(img,train,test,gt_map,...
%              learning_method,algorithm_parameters,flg,SSL_sampling,mflg);
%
%
% -------------- Brief description ----------------------------------------
%
% This demo implements the algorithm introduced in [1] (see also [2]). 
%   
% In summary:
%
...
%
%    2- Use the obtained classification map and the neighborhood
...
%                    candidate - candidate testing set
...
% More details in
%
% [1] I. D¨®pido, J. Li, P. R. Marpu, A. Plaza, J. M. Bioucas Dias and 
% J. A. Benediktsson, Semisupervised Self-Learning for Hyperspectral Image 
% Classification. IEEE Transactions on Geoscience and Remote Sensing, 
% vol.51, no.7, pp.4032-4044, July 2013.
%
% [2] C. Liu, J. Li and L. He, Superpixel-Based Semisupervised Active 
...
% the 3rd parameter is the testing set
if nargin >2
    test = varargin{3};
else
...
for iter = 1:tot_sim
    ...
    % compute the MLR classification results
    ...
    % gather the confident neighbor samples/candidate set after Q_f
    SSLSet = []; % the confident neighbor set
